...
// import { IPriceOracleV2 } from "../../interfaces/gearbox/IPriceOracle.sol";
// import { IAddressProvider } from "../../interfaces/gearbox/IAddressProvider.sol";

// contract SlippageAccounter is Ownable {
...
// 		);
// 		uint256 wethBorrowed = priceOracle.convert((amountIn * leverage) / MAX_BPS, FRAX, WETH);
...
// 		uint256 slippageAmount = (amountIn * (wethBorrowed - wethReturned)) / (2 * wethBorrowed); // half to account for only deposit
