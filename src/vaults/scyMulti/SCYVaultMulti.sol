...
import { SCYStrategyMulti, StrategyMulti as Strategy } from "./SCYStrategyMulti.sol";
import { IMX } from "../../strategies/imx/IMX.sol";

// import "hardhat/console.sol";

abstract contract SCYVaultMulti is Initializable, SCYStrategyMulti, SCYBaseMulti, FeesU, TreasuryU {
	...
	{
		Strategy storage strategy = strategies[id];
		if (token == address(strategy.underlying)) return IERC20(token).balanceOf(address(this));
